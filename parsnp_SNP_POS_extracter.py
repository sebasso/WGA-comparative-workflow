...
def parsesnps():
	...
	inputSnps=""
	with open(sys.argv[1]+"/parsnp.xmfa","r") as f:
	...
	for key,val in snps.items():
		for entry in val:
			...
			if ".ref" in placeholder[0]: #WARNING: may be inconsistent
	...
	currpath=os.getcwd()
	#sys.argv[1]=parsnp_output
	outputfile=sys.argv[1]+"/"+"parsnp_SNPs_POS_formatted.tsv"
...
if __name__ == '__main__':
	sys.stderr.write("/nPARSNP_SNP_extracter args:\n")
	sys.stderr.write(str(sys.argv))
	sys.stderr.write("\n")
	#usage: sys.argv[1] = SNPs_all file from parsnp output
	parsesnps()
